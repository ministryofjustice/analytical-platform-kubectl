...
```bash
docker pull --platform linux/amd64 docker.io/alpine:3.24.2

docker image inspect --format='{{index .RepoDigests 0}}' docker.io/alpine:3.24.2
```
...
```bash
docker run -it --rm --platform linux/amd64 docker.io/alpine:3.24.2
